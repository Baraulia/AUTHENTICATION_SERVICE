...
//	type mockBehaviorId func(s *mock_repository.MockAppUser, user *model.UserDB)
...
//			},
//			mockBehaviorId: func(s *mock_repository.MockAppUser, user *model.UserDB) {
...
//			defer c.Finish()
//			auth := mock_repository.NewMockAppUser(c)
//			testCase.mockBehaviorId(auth, &model.UserDB{
//				Email:    testCase.inputUser.Email,
//				Role:     "Authorized Customer",
//				Password: "$2a$10$JITroeA6GzTt6IRKZ5ij7eSBoCrEXBnxs5W/qTCykLShAL/38MoWi",
//			})
//			logger := logging.GetLogger()
//			repo := &repository.Repository{AppUser: auth}
//			grpcCli := grpcClient.NewGRPCClient("159.223.1.135")
